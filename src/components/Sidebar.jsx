...
export default function Sidebar() {
  ...
  return (
    <>
      <aside
        ref={aside}
        className='group fixed left-0 top-0 w-10/12 xs:w-9/12 sm:w-8/12 md:w-12 md:hover:w-60 h-screen transform -translate-x-full md:transform-none overflow-x-hidden bg-gray-900 z-50'>
