...
export default function Header() {
  const { handleNotifbar, notifbar, profileMenu, handleProfileMenu } =
    useContext(Theme)
  ...
  return (
    <header className='flex items-center justify-between fixed top-0 w-full h-12 sm:h-14 md:h-16 px-2 sm:px-4 md:px-6 lg:pl-76 lg:pr-4 bg-white z-40'>
      ...
      <div className='relative flex items-center justify-end w-full h-full space-x-2'>
        <button
          ...
          className='grid place-items-center w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-md text-base md:text-lg lg:text-xl text-gray-700 hover:shadow-md'>
        ...
        <div
          ...
          <ul className='w-full py-1 h-full overflow-y-scroll'>
        ...
        <button
          ...
          className='grid place-items-center w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 rounded-md hover:shadow-md bg-white'>
          <img className='w-6' src={image} alt='profileImage' />
        </button>

        <div
          ref={profileMenu}
          className='absolute top-12 sm:top-14 md:top-16 w-full lg:w-1/3 h-0 shadow-md rounded-md overflow-hidden bg-white'>
